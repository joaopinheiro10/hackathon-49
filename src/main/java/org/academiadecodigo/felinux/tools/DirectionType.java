...
public enum DirectionType {
    ...
    FRONT(new String[]{"/img/chars/girl/WALK_BACK_1.png", "/img/chars/girl/WALK_BACK_2.png", "/img/chars/girl/WALK_BACK_3.png", "/img/chars/girl/WALK_BACK_4.png"}),
    BACK(new String[]{"/img/chars/girl/WALK_FRONT_1.png", "/img/chars/girl/WALK_FRONT_2.png", "/img/chars/girl/WALK_FRONT_3.png", "/img/chars/girl/WALK_FRONT_4.png"}),
